...
- Every accepted concern must persist in required detail pages. Inline delivery is best effort. Analysis and publication statuses are separate; findings never decide exit code or a merge verdict.
